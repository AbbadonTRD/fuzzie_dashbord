import LaneForm from '@/components/plura/forms/lane-form'
...
const PipelineView = ({
  ...
  // Safely populate ticketsFromAllLanes
  const ticketsFromAllLanes: TicketAndTags[] = []
  lanes.forEach((item) => {
    // Check if item.Tickets is defined and is an array
  ...
  const onDragEnd = (dropResult: DropResult) => {
    ...
    switch (type) {
      case 'lane': {
        ...
        break; // Ensure to break after the case
      }
