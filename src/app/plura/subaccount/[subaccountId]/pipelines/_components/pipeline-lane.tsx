'use client'
import CreateLaneForm from '@/components/plura/forms/lane-form'
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
import TicketForm from '@/components/plura/forms/ticket-form'
import PipelineTicket from './pipeline-ticket'

interface PipelaneLaneProps {
  setAllTickets: Dispatch<SetStateAction<TicketWithTags>>
  allTickets: TicketWithTags
  tickets: TicketWithTags | undefined // Allow tickets to be undefined
  pipelineId: string
...
const PipelineLane: React.FC<PipelaneLaneProps> = ({
  ...
  const dummyTickets: TicketWithTags[] = [
    { id: '1', name: 'Ticket 1', value: 100, laneId: laneDetails.id },
    { id: '2', name: 'Ticket 2', value: 200, laneId: laneDetails.id },
    { id: '3', name: 'Ticket 3', value: 300, laneId: laneDetails.id },
  ]

  // Use dummy data if no tickets are passed or if tickets is undefined
  const currentTickets = Array.isArray(tickets) && tickets.length > 0 ? tickets : dummyTickets
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      your lane and remove all associated tickets.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
