...
const Page: React.FC<Props> = ({ params }) => {
  // Since we're using dummy data, no need for async operations
  ...
  const currentPlanDetails = dummyCurrentPlanDetails
    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        <PricingCard
          ...
          prices={prices.data}
          customerId={agencySubscription.customerId}
          amt={agencySubscription.Subscription.active ? currentPlanDetails.price : '$0'}
          buttonCta={agencySubscription.Subscription.active ? 'Change Plan' : 'Get Started'}
          highlightDescription="Want to modify your plan? You can do this here. If you have
          ...
          title={agencySubscription.Subscription.active ? currentPlanDetails.title : 'Starter'}
        />
        {addOns.map((addOn) => (
          <PricingCard
            planExists={agencySubscription.Subscription.active}
            ...
            customerId={agencySubscription.customerId}
            key={addOn.id}
            amt={addOn.default_price.unit_amount ? `$${addOn.default_price.unit_amount / 100}` : '$0'}
            buttonCta="Subscribe"
