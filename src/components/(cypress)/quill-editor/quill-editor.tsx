...
const QuillEditor: React.FC<QuillEditorProps> = ({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    //@ts-expect-error
    const socketHandler = (range, roomId: string, cursorId: string) => {
      if (roomId === fileId) {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    //@ts-expect-error
    const quillHandler = (delta, source) => {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    //@ts-expect-error
    const socketHandler = (deltas, id: string) => {
      if (id === fileId) {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        //@ts-expect-error
  ...
  return (
    <>
      ...
      >
        ...
        <div
          id="container"
          className="max-w-[800px] h-44 border rounded overflow-hidden"
          // eslint-disable-next-line @typescript-eslint/ban-ts-comment
          //@ts-expect-error
          ref={wrapperRef}
        ></div>
