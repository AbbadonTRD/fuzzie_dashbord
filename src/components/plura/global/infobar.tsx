              ...
              {allNotifications?.map((notification) => (
                ...
                >
                  <div className="flex gap-2">
                    <Avatar>
                      <AvatarImage
                        src={notification.User?.avatarUrl} // Optional chaining for avatarUrl
                        alt="Profile Picture"
                      />
                      <AvatarFallback className="bg-primary">
                        {notification.User?.name ? 
                          notification.User.name.slice(0, 2).toUpperCase() : 'NN'} // Optional chaining for name
                      </AvatarFallback>
                    </Avatar>
                    <div className="flex flex-col">
                      <p>
                      ...
                      <small className="text-xs text-muted-foreground">
                        {new Date(notification.createdAt)?.toLocaleDateString() || 'N/A'} // Optional chaining for createdAt
                      </small>
                    </div>
                  </div>
                </div>
